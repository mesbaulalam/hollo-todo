...
const Header: React.FC = () => {
  return (
    <div className="bg-gray-50 h-2/5">
      <div className="flex justify-center pt-8 relative items-center">
        <div className="mr-12">About Us</div>
        <div>Contact Us</div>
        <div className="absolute right-16 py-2 px-4 bg-green-400 text-white z-10 rounded-md">
          Sign Up!
        </div>
